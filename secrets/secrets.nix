let
  ...
  # Bulldozer
  bulldozer_host = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAICGYOoPbthroSXWVyoqjWHipk3WCe3IdhziSO+2e9XtT root@bulldozer";
  # Raphael
...
in
{
  ...
  # Raphael
  "nate_raphael_user_password.age".publicKeys = [
    raphael_host
    raphael_nate
  ];
